...
namespace SoftUnlimit.Cloud.VirusScan.Data.Model
{
    ...
    public class Complete : EventSourced<Guid>
    {
        ...
        /// <returns></returns>
        public IVersionedEvent AddEvent(Type eventType, ICloudIdGenerator gen, string correlationId, object body) => AddVersionedEvent(eventType, gen.GenerateId(), gen.ServiceId, gen.WorkerId, correlationId, body);
    }
}
