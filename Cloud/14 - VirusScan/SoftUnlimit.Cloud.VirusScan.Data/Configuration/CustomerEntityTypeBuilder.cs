...
namespace SoftUnlimit.Cloud.VirusScan.Data.Configuration
{
    public class CustomerEntityTypeBuilder : _EntityTypeBuilder<Customer>
    {
        public override void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            builder.Property(p => p.FirstVirusDetected).HasComment("Date when some request has mark with virus for first time").HasConversion(DateTimeUtcConverter.Instance);
