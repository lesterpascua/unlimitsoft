...
namespace App.Manual.Tests.CQRS.Data
{
    ...
    public class Dummy : EventSourced<Guid>
    {
        ...
        public void AddMasterEvent(Guid eventId, ICommand creator, DummyDTO prevState, DummyDTO currState) => base.AddMasterEvent(eventId, 1, "0", creator, prevState, currState);
    }
}
