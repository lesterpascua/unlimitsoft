...
public sealed class RepositoriesAvailables 
{
    ...
    /// 
    /// </summary>
    /// <param name="serviceType">Interface reference to mutable repository. If can't mutate the entity this value is null.</param>
    ...
    /// <summary>
    /// Interface reference to mutable repository. If can't mutate the entity this value is null.
    /// </summary>
