...
{
    /// <summary>
    /// Indicate if for serializer use Newtonsoft or Native serializer in the internal UnlimitSoft library operation. By default use Newtonsoft.
    /// </summary>
    ...
    public static object AddNode(object? body, string name, object value, object? settings = null)
    {
        ...
        if (body is not null)
        {
            ...
            dictionary = System.Text.Json.JsonSerializer.Deserialize<Dictionary<string, object>>(json, (settings as JsonSerializerOptions) ?? TextJsonSerializerSettings);
        }
        ...
        return System.Text.Json.JsonSerializer.Deserialize<object>(jsonWithProperty, (settings as JsonSerializerOptions) ?? TextJsonSerializerSettings)!;
    }
